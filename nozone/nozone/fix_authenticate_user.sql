-- Fix for ambiguous username column reference in authenticate_user function
-- Run this in your Supabase SQL Editor to fix the sign-in issue
...
-- SELECT * FROM authenticate_user('test_username', 'test_password');
